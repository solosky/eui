...
/* Pointers to views needed by tick callback for dirty marking */
...
static uint32_t amiibo_tick(void) {
    uint32_t now = AMIIBO_GET_TICK_MS();
...
void eui_example_setup(const eui_example_config_t *cfg) {
    ...
    eui_view_t *app_view = (eui_view_t*)eui_malloc(sizeof(eui_view_t));
    eui_view_t *amiibo_view = (eui_view_t*)eui_malloc(sizeof(eui_view_t));
    eui_view_t *detail_view = (eui_view_t*)eui_malloc(sizeof(eui_view_t));
    eui_view_t *nfc_view = (eui_view_t*)eui_malloc(sizeof(eui_view_t));
    eui_view_t *settings_view = (eui_view_t*)eui_malloc(sizeof(eui_view_t));
