/* 4bpp config override.  Included via -include BEFORE any library source
...
#ifndef CONFIG_4BPP_OVERRIDE
#define CONFIG_4BPP_OVERRIDE

#define EUI_CONFIG_H            1       /* blocks generated config.h    */
#define EUI_COLOR_DEPTH         4
#define EUI_CANVAS_STATE_STACK  4
#define EUI_MEM_POOL_SIZE   32768
